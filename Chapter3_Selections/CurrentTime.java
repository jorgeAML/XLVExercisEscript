...
public class CurrentTime {
    public static void main(String[] args) {
        ...
        if (formula < 13) {
            System.out.println("Your Current time is: " + formula + ":" + currentMinutes + ":" + currentSeconds + " AM");
        } else {
            System.out.println("Your Current time is: " + formula + ":" + currentMinutes + ":" + currentSeconds + " PM");
        }
    }
}